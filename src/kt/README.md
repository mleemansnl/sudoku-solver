# Kotlin implementation for Algorithm X & Dancing Links (DLX)
...
```shell
cat examples/sudoku-4x4.txt | bazel run //src/kt/com/sudokusolver/main:Main
cat examples/sudoku-9x9.txt | bazel run //src/kt/com/sudokusolver/main:Main
cat examples/sudoku-16x16.txt | bazel run //src/kt/com/sudokusolver/main:Main
```

To test, run:

```shell
bazel test --test_output=all //src/kt/...
# or, from the src/kt directory:
./gradlew test
```
