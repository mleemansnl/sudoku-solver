 ...
 *
 * Given a digit range D (in a normal 9x9 Sudoku, D == 9), then: - row value ranges 1..D inclusive -
 * column value ranges 1..D inclusive - number value ranges 1..D inclusive
 */
